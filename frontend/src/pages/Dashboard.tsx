    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-8 flex flex-wrap gap-4 items-end">
        <div className="flex-1 min-w-50">
          ...
          <select 
            className="w-full bg-gray-50 border-none rounded-lg p-2 text-sm focus:ring-2 ring-indigo-500 outline-none"
        ...
        <div className="flex-1 min-w-37.5">
          ...
          <input 
            type="date" 
            className="w-full bg-gray-50 border-none rounded-lg p-2 text-sm outline-none"
            value={startDate}
      ...
      <DashboardCharts filteredTransactions={filteredTransactions} stats={stats} />
